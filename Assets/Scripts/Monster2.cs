...
public class My_AIController : MonoBehaviour
{
    ...
    [SerializeField] private AudioSource ScreamAudioSource = default;
    [SerializeField] private AudioClip[] ScreamClips = default;
    [SerializeField] private float ScreamVolume = 0.1f;
    private bool m_Screaming = false;
    ...
    {
            EnviromentView1();                       //  Check whether or not the player is in the enemy's field of vision
    ...
    private void Patroling1()
    {
        if (m_PlayerNear)
        {
            ...
            {
                Move1(speedWalk);
                LookingPlayer1(playerLastPosition);
            }
            else
            {
    ...
    void LookingPlayer1(Vector3 player)
    {
